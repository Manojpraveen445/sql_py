...
while True:
    try:
        ...
        if re.search('quit', query, re.IGNORECASE):
            break
        elif re.search('list', query, re.IGNORECASE):
            print(df.columns)
        
        # For making Visualization 2D or 1D
        elif re.search('graphs', query, re.IGNORECASE):
        ...
        elif re.search('SQL', query,re.IGNORECASE):
